package com.popular_movies.ui.listing.movies_listing.filter;
...
public class MyFabFragment extends AAH_FabulousFragment {
    ...
    Button imgbtn_refresh, imgbtn_apply;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        applied_filters = ((MovieListFragment) getParentFragment()).getApplied_filters();
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        RelativeLayout ll_buttons = (RelativeLayout) contentView.findViewById(R.id.ll_buttons);
        imgbtn_refresh = (Button) contentView.findViewById(R.id.imgbtn_refresh);
        imgbtn_apply = (Button) contentView.findViewById(R.id.imgbtn_apply);
...
//            ll_scroll.setLayoutParams(lp);
    ...
    private void inflateLayoutWithFilters(final String filter_category, FlexboxLayout fbl) {
        ...
        switch (filter_category) {
            case "genre":
//                keys = ((MovieListFragment) getParentFragment()).getUniqueGenreKeys();
                break;
            case "rating":
                keys = ((MovieListFragment) getParentFragment()).getUniqueRatingKeys();
                break;
            case "year":
                keys = ((MovieListFragment) getParentFragment()).getUniqueYearKeys();
                break;
            case "quality":
//                keys = ((MovieListFragment) getParentFragment()).getMovieData().getUniqueQualityKeys();
                break;
        }
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (tv.getTag() != null && tv.getTag().equals("selected")) {
                        ...
                        tv.setTextColor(ContextCompat.getColor(getContext(), R.color.pureBlack));
